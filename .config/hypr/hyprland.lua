...
local function change_layout()
  ...
  os.execute(string.format('notify-send -u low "Layout set to" "%s" &', new_layout))
end
...
---CHANGE BETWEEN Dwindle and scrolling
hl.bind(mainMod .. " + escape", change_layout)
...
hl.bind(
	mainMod .. " + SHIFT + S",
	hl.dsp.exec_cmd(
		"hyprshot -m region -m eDP-1 -z -s -f Screenshot__$(date +'%d-%m-%Y__%H-%M-%S').png -o ~/Pictures/Screenshots"
	),
...
hl.bind(
	mainMod .. "+ PRINT",
	hl.dsp.exec_cmd(
		"hyprshot -m window -m eDP-1 -z -s -f Screenshot__$(date +'%d-%m-%Y__%H-%M-%S').png -o ~/Pictures/Screenshots"
	),
	{ locked = false, repeating = false }
)
hl.bind(
	"PRINT",
	hl.dsp.exec_cmd(
		"hyprshot -m output -m eDP-1 -z -s -f Screenshot__$(date +'%d-%m-%Y__%H-%M-%S').png -o ~/Pictures/Screenshots "
	),
	{ locked = false, repeating = false }
)
...
hl.bind(
	mainMod .. " + SHIFT + A",
	hl.dsp.exec_cmd("~/.config/hypr/scripts/ssdmenusatty.sh"),
	{ locked = false, repeating = false }
)
...
hl.bind(mainMod .. "+ F", hl.dsp.window.fullscreen({ actoan = toggle }))
